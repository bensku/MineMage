...
{
    public BlockSkyPortal(int par1)
    {
        super(par1, "skyportal", Material.portal, false);
        this.setUnlocalizedName("skyPortal");
        this.setTickRandomly(true);
        this.setCreativeTab(MainMod.tabMineMage);
    }

    
	public void registerIcons(IconRegister iconRegister)
	{
	         blockIcon = iconRegister.registerIcon("MineMage:BlockSkyPortal");
	}
...
*/
    public static boolean tryToCreatePortal(World par1World, int par2, int par3, int par4)
    {
        ...
        if (par1World.getBlockId(par2 - 1, par3, par4) == Block.stone.blockID || par1World.getBlockId(par2 + 1, par3, par4) == Block.stone.blockID)
        {
            b0 = 1;
        }

        if (par1World.getBlockId(par2, par3, par4 - 1) == Block.stone.blockID || par1World.getBlockId(par2, par3, par4 + 1) == Block.stone.blockID)
        {
            b1 = 1;
        }
        ...
        else
        {
            ...
            for (l = 0; l < 2; ++l)
            {
                for (i1 = 0; i1 < 3; ++i1)
                {
                    par1World.setBlock(par2 + b0 * l, par3 + i1, par4 + b1 * l, MainMod.BlockSkyPortal.blockID, 0, 2);
                }
            }
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        else
        {
            ...
            if (j1 == 3 && par1World.getBlockId(par2, i1 + j1, par4) == Block.stone.blockID)
            {
                ...
                {
                    if ((par1World.getBlockId(par2 + b0, par3, par4 + b1) != Block.stone.blockID || par1World.getBlockId(par2 - b0, par3, par4 - b1) != this.blockID) && (par1World.getBlockId(par2 - b0, par3, par4 - b1) != Block.stone.blockID || par1World.getBlockId(par2 + b0, par3, par4 + b1) != this.blockID))
                    {
                        par1World.setBlockToAir(par2, par3, par4);
                    }
                }
